...
export default function Rapidly() {
    return(
        <div className="bg-black w-full px-3.5 py-5 lg:p-10 flex justify-center items-center">
            <div className="flex flex-col items-center max-w-6xl space-y-4 md:flex-row md:space-y-0 md:space-x-20 md:px-5">
                ...
                <div className="space-y-2.5 px-3.5 sm:px-5 md:px-0 md:max-w-2xl">
